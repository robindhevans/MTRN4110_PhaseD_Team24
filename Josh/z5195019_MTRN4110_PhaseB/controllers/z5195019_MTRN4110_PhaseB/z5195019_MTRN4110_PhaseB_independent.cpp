...
int main(int argc, char **argv) {
  ...
  //std::cout << "Horizontal wall array" << std::endl;
  for(i = 0; i< MAP_TEXT_ROWS; i += 2){
    ...
    for (j = 2; j < MAP_TEXT_COLS; j +=4){
      ...
      //std::cout <<  map.hwalls[rowwall][colwall] << " "; // hoizontal wall array printout
      colwall++;
    }
    //std::cout << std::endl;
    rowwall++;
  ...
  j = 0;
  rowwall = 0;
  //std::cout << "Vertical wall array" << std::endl;
  for (i = 1; i < MAP_TEXT_ROWS; i += 2){
    ...
    for (j = 0; j < MAP_TEXT_COLS; j += 4){
      ...
      //std::cout << map.vwalls[rowwall][colwall] << " "; // vertical wall array printout
      colwall++;
    }
    //std::cout << std::endl;
    rowwall++;
  ...
  std::cout << "Steps: " << route->instr.size()-3 << std::endl;
  std::cout << "Path: ";
  ...
  //print to text file;
   ...
   if (!pathfile.is_open()) {
    std::cout << "Failed to pathplan" << std::endl;
    std::cout << "Exiting Controller..." << std::endl;
    exit(EXIT_FAILURE);
  } 
    
  std::cout << "File: " << PATH_OUTPUT << std::endl;
